...
#define STRING_CONFIG_H_AUTHOR "(JHurdle91, HICTOP PRUSA i3 Mendel)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Scuzzlebutt"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 394, 97.4 }
